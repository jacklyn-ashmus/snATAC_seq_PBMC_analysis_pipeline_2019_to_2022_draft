...
cellTypes=( acinar activatedStellate alpha_2 beta_2 beta_4 beta_6 ductal    endothelial macrophage quiescientStellate
acinarREGPOS alpha_1   beta_1  beta_3 beta_5 delta  ductalMUC5B mast tCell )
...
matPrefix=/nfs/lab/projects/multiomic_islet/outputs/multiome/call_peaks/31mergedPeaks_final/
matrSuffix=.lf_mtx.gz
WD=/nfs/lab/jnewsome/multiome/cicero/output/
################# b 
