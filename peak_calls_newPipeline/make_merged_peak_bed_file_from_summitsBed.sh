...
SUMMITS_BED_SUFFIX=_summits.bed
SUMMITS_BED_BARE_SUFFIX=.summits.bared.bed
...
# echo ""
# echo "cat_sorted_file : ${cat_sorted_file}"
# echo ""
# echo "cat_sorted_filtered_file : ${cat_sorted_filtered_file}"
# echo ""
# echo "merged_file : ${merged_file}"
# echo ""
# echo "output_merged_bed : ${output_merged_bed}"
# echo ""
# echo "output_merged_bare_bed : ${output_merged_bare_bed}"
# echo ""
# echo "celltypes:"
# echo "${celltypes[@]}"
# echo ""
...
for cell in "${celltypes[@]}"; do
    in_narrowpeak_file="${IN_PEAK_DIR}${cell}${SUMMITS_BED_SUFFIX}"
    out_bed_file="${OUT_PEAK_DIR}${cell}${SUMMITS_BED_BARE_SUFFIX}"
#     echo "${out_bed_file}"
...
for cell in "${celltypes[@]}"; do
    bedfile="${OUT_PEAK_DIR}${cell}${SUMMITS_BED_BARE_SUFFIX}"
    cat "${bedfile}"
done > ${cat_file}
...
# echo "bedtools intersect -a ${cat_sorted_file} -b ${ENCODE_BLACKLIST_FILE}  -wa -v > ${cat_sorted_filtered_file}"

bedtools intersect -a ${cat_sorted_file} -b ${ENCODE_BLACKLIST_FILE} -wa -v > ${cat_sorted_filtered_file}

# head ${cat_sorted_filtered_file} 
# ln -s ${cat_sorted_filtered_file} ${cat_sorted_filtered_file_softlink}
