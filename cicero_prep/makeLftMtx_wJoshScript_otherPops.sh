...
otherPops=(cd4_t cd8_t mkc mono nk pDC plasma act_cd4_t cyto_cd8_t mem_b naive_b ncMono tReg adaptive_NK cyto_nk mem_cd8_t naive_cd4_t cDC cMono iMono naive_cd8_t )
