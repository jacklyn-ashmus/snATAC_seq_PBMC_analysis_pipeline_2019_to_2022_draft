...
inDir_fine=/nfs/lab/projects/pbmc_snATAC/pipeline/snATAC/combined_files/pbmc1to15/lf_mtx/fine_pop/
outDir_fine=/nfs/lab/jnewsome/pbmc/split_lf_mtx/fine/
...
inDir_broad=/nfs/lab/jnewsome/pbmc/mtx_broadPops/
outDir_broad=/nfs/lab/jnewsome/pbmc/split_lf_mtx/broad/
...
inFile="${inDir_fine}${infile2Prefix}${cell}${insuffix}"


for chr in ${chroms[@]}; do 
outfile="${outDir_fine}${infile2Prefix}${cell}.chr${chr}${out1Suffix}"
outfileSort="${outDir_fine}${infile2Prefix}${cell}.chr${chr}.sorted${out1Suffix}"
grepThing="${chr}:"
